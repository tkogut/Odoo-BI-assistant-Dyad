...
// Prefer VITE_RELAY_HOST provided at build-time (via Docker build-arg or Vite), otherwise fallback to empty string.
  ...
  const onTestConnection = async () => {
    ...
    try {
      ...
      const entry: ConnectionTest = {
        ...
        status: resp.status,
        statusText: resp.statusText,
        preview: parsed ?? (await safeTextPreview(resp)),
      };
      recordTest(entry);
